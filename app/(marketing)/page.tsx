  ...
  return (
    <div className="overflow-x-hidden pb-24 sm:pb-0">
      ...
      <section className="py-12 sm:py-20 bg-surface border-y border-border">
        ...
        <Reveal>
          <Carousel>
            {['public/bonus/1.webp', 'public/bonus/2.webp', 'public/bonus/3.webp', 'public/bonus/4.webp', 'public/bonus/5.webp', 'public/bonus/6.webp', 'public/bonus/7.webp'].map((src, i) => (
      ...
      <section className="px-4 py-12 sm:py-20">
        ...
        <Reveal>
          <Carousel className="max-w-4xl mx-auto">
            {['public/prints/PROVASOCIAL01.png', 'public/prints/PROVASOCIAL02.png', 'public/prints/PROVASOCIAL03.png'].map((src, i) => (
